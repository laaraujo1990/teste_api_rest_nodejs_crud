...
- iniciar projeto: yarn init -y (iniciar projeto e cria um package.json)
- criar servidor: yarn add express (cria pasta node modules)
- rodar: node server.js
- testar: insonmia: Ex: GET http://localhost:3000/clientes/1
